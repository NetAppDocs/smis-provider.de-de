...
image::../media/smi_s_provider_workflow.gif[Ein Diagramm, das die Bereitstellung des SMI-S Provider, die Validierung der Vorkonfiguration und die Arbeitsabläufe für Verwaltungsaufgaben zeigt]
