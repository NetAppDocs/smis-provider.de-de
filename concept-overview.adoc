...
summary: Mit NetApp SMI-S Provider 5.2.5 können Sie Storage-Systeme verwalten und überwachen sowie LUNs und Volumes von Storage-Systemen, CIMOM-Konfigurationseinstellungen und CIM-Server-Benutzer verwalten. 
---
= Überblick
:allow-uri-read: 
:icons: font
...
[role="lead"]
Mit NetApp SMI-S Provider 5.2.5 können Sie Storage-Systeme verwalten und überwachen sowie LUNs und Volumes von Storage-Systemen, CIMOM-Konfigurationseinstellungen und CIM-Server-Benutzer verwalten.
