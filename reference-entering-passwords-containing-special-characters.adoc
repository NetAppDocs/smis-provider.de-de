...
[role="lead"]
Passwörter, die Sonderzeichen enthalten, können dazu führen, dass der  `smis` Befehl in einer Windows-Umgebung fehlschlägt. Solche Passwörter sollten in doppelte Anführungszeichen gesetzt werden, damit die Eingabe erfolgreich ist.
