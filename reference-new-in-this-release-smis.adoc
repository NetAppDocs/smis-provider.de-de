...
[role="lead"]
NetApp SMI-S Provider 5.2.7 führt neue Anforderungen und Einschränkungen ein, einschließlich unterstützter Windows- und System Center Virtual Machine Manager (SCVMM)-Versionen. Diese Änderungen sollten vor der Bereitstellung oder Aktualisierung auf diese Version geprüft werden.
