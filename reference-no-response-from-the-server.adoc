...
[role="lead"]
NetApp SMI-S Provider antwortet möglicherweise nicht auf eine Abfrage, wenn dem CIMOM-Repository kein Speichersystem hinzugefügt wurde. Es sollte überprüft werden, ob ein Speichersystem registriert ist, und bei Bedarf eines hinzugefügt werden.
